...
async function RDSfunvlna(rdsUrl: rdsFormat) {
	...
	const rdsData = (rdsParse.getElementsByTagName("interpret")[0].childNodes[0].nodeValue + " - " + rdsParse.getElementsByTagName("skladba")[1].childNodes[0].nodeValue).normalize("NFD").replace(/[\u0300-\u036f]/g, "")
	return (rdsData);
}
